...
int main(int argc, char **argv)
{
  ...
  static const std::string PLANNING_GROUP = "end_gr"; /* Now we specify with what group we want work,
  ...
  while (ros::ok()){
	std_msgs::Float64MultiArray x_y_msg;
